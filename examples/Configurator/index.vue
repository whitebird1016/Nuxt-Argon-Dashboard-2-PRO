      ...
      <div class="pt-0 card-body pt-sm-3">
        ...
        <div class="mt-3 d-flex">
          ...
          >
            <input
              id="navbarFixed"
              class="mt-1 form-check-input float-end me-auto"
              type="checkbox"
...
const sidenavType = computed(() => {
  return appStore.sidenavType;
});
const showConfig = computed(() => {
  return appStore.showConfig;
});
function toggleShowConfig() {
  appStore.toggleShowConfig();
}
function setSidenavType(type) {
  appStore.setSidenavType(type);
}
