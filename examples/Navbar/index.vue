    ...
    :class="`${
      appStore.navFixed
        ? `navbar navbar-main navbar-expand-lg px-0 mx-4 border-radius-xl shadow-none position-sticky ${
            appStore.darkMode ? 'bg-default' : 'bg-white'
  ...
  >
    <div class="px-3 py-1 container-fluid">
      ...
      <div class="sidenav-toggler sidenav-toggler-inner d-xl-block d-none">
        <a href="#" class="p-0 nav-link text-body" @click="toggleSidenav">
          <div class="sidenav-toggler-inner">
            <i
              class="sidenav-toggler-line"
              :class="
                appStore.navFixed && !appStore.darkMode
                  ? 'opacity-8 bg-dark'
                  : 'bg-white'
              "
            ></i>
          ...
          <li class="px-3 nav-item d-flex align-items-center">
            <a class="p-0 nav-link" @click="toggleShowConfig">
              <i
                ...
                :class="
                  appStore.darkMode || !appStore.navFixed
                    ? 'text-white'
                    : 'text-dark opacity-8'
                "
              ></i>
