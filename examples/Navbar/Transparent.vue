<template>
  <nav
    ...
    :class="
      props.isBlur ? props.isBlur : 'shadow-none my-2 navbar-transparent w-100'
    "
  >
    <div class="container ps-2 pe-0">
      <NuxtLink
        class="navbar-brand font-weight-bolder ms-lg-0 ms-3"
        :class="props.darkMode ? 'text-black' : 'text-white'"
        to="/"
          ...
          <li class="mx-2 nav-item dropdown dropdown-hover">
            ...
            >
              ...
              <img
                ...
                alt="down-arrow"
                class="arrow ms-1"
                :class="props.darkMode ? 'd-none' : 'd-lg-block d-none'"
              />
              <img
                :src="downArrBlack"
                alt="down-arrow"
                class="arrow ms-1 d-block"
                :class="props.darkMode ? 'd-lg-block' : 'd-lg-none'"
              />
            </a>
            <div
            ...
            >
              ...
              <div class="row d-lg-none">
                <div class="col-md-12 g-0">
                  <a class="py-2 dropdown-item ps-3 border-radius-md" href="#">
                    <div class="d-flex">
                      <div class="h-10 mt-1 icon me-3 d-flex">
                        <i class="ni ni-planet text-success"></i>
                      </div>
        ...
        <ul class="navbar-nav d-lg-block d-none">
          <li class="nav-item">
            <a
              ...
              :class="
                props.btnBackground ? props.btnBackground : 'bg-white text-dark'
              "
...
const isDark = computed(() => {
  return props.darkMode ? "text-dark" : "";
});
</script>
