              ...
              <div class="mx-auto mt-4 mb-3 col-12 col-lg-8 mb-sm-5">
                <div class="multisteps-form__progress">
                  ...
                  <button
                    ...
                    :class="{
                      'js-active':
                        currentTab === 'Socials' || currentTab === 'Pricing',
                    }"
...
const currentTab = ref("ProductInfo");
const tabs = {
  ProductInfo,
  Media,
  Socials,
...
const prevStep = () => {
  if (currentTab.value === "Pricing") {
    ...
    return (currentTab.value = "ProductInfo");
  }
};
</script>
